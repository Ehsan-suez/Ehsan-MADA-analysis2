...
knitr::kable(resulttable, caption = 'Linear model fit table Weeks and Doses.')
```
...
knitr::kable(resulttable, caption = 'Linear model fit table for Weeks and Cumulative Doses.')
```
